...
namespace ADO.NET {
    ...
    public partial class NorthwindDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            fkc = new global::System.Data.ForeignKeyConstraint("FK_Products_Categories", new global::System.Data.DataColumn[] {
...
SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = @ProductID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[3].CommandText = "INSERT INTO Products\r\n                            (ProductName, Discontinued)\r\nVA" +
            ...
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Discontinued", global::System.Data.SqlDbType.Bit, 1, global::System.Data.ParameterDirection.Input, 0, 0, "Discontinued", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
