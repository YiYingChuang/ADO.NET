...
namespace ADO0NET.NorthwindDataSetTableAdapters {
...
SELECT CategoryID, CategoryName, Description, Picture FROM Categories WHERE (CategoryID = @CategoryID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ADO0NET.Properties.Settings.Default.northwindConnectionString;
        }
...
SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = SCOPE_IDENTITY())";
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Discontinued", global::System.Data.SqlDbType.Bit, 1, global::System.Data.ParameterDirection.Input, 0, 0, "Discontinued", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual NorthwindDataSet.ProductsDataTable GetDataBy(global::System.Nullable<decimal> UnitPrice) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((UnitPrice.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(UnitPrice.Value));
            }
        ...
        public virtual int InsertProducts(string ProductName, bool Discontinued) {
    ...
    public partial class UserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[User] SET [UserName] = @UserName, [Password] = @Password WHERE (([U" +
                ...
                "serName, Password FROM [User] WHERE (UserName = @UserName)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(NorthwindDataSet.UserDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual NorthwindDataSet.UserDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            NorthwindDataSet.UserDataTable dataTable = new NorthwindDataSet.UserDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(NorthwindDataSet.UserDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
